...
export default function Home() {
  ...
  const cards = [["Executions", summary.total_executions], ["Filled", summary.filled_executions], ["Protected", summary.protected_executions], ["Reconciled", summary.reconciled_executions], ["Paper P&L", summary.total_realized_pnl]];
